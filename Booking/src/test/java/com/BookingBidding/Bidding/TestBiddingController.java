...
import com.BookingBidding.Bidding.Controller.BiddingController;
...
import com.BookingBidding.Booking.Util.JwtUtil;
...
public class TestBiddingController {
	...
	public void addData() throws Exception {
		...
		when(biddingService.addBid(Mockito.any(BidPostRequest.class), Mockito.anyString())).thenReturn(bidPostResponse);
...
//
	...
	public void updateData() throws Exception {
		...
		BidPutResponse response = new BidPutResponse(Constants.uSuccess, Constants.ID,
				"transporterId:0de885e0-5f43-4c68-8dde-b0f9ff81cb69", "load:123", (long) 20, null, BiddingData.Unit.PER_TRUCK,
				Arrays.asList("truck:123"), true, false, null);
	...
	public List<BiddingData> createBiddingData() {
		List<BiddingData> biddingList = Arrays.asList(
				new BiddingData(Constants.ID, Constants.TRANSPORTER_ID, "load:1234", (long) 20, null,
						BiddingData.Unit.PER_TON, Arrays.asList("truck:123"), false, true, null, null),
